...
public class UserAccountController {
	...
	public ModelAndView verifyLogin(ModelAndView modelAndView, User user)
	{

		User existingUser = userRepository.findByEmailIdIgnoreCaseAndPassword(user.getEmailId(), user.getPassword());
		...
		else
		{
			if(existingUser.isEnabled()) {
				...
				modelAndView.addObject("message",user.getEmailId() + " has not verified their email address.");
				modelAndView.setViewName("error");
			}
		}
	...
	public ModelAndView registerUser(ModelAndView modelAndView, User user)
	{
		...
		else 
		{
			...
			mailMessage.setFrom("ncisecprogweb@gmail.com");
			mailMessage.setText("To confirm your account, please click here : "
			+"http://178.62.117.201:8082/confirm-account?token="+confirmationToken.getConfirmationToken());
